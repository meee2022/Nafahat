        ...
        <View style={{ marginTop: 24, paddingHorizontal: 20 }}>
          ...
          >
            ...
            <View style={{ flex: 1, marginHorizontal: 12 }}>
              <Text style={{ color: t.colors.textPrimary, fontWeight: '800', fontSize: 14 }}>الأدوات والمكتبة</Text>
              <Text style={{ color: t.colors.textTertiary, fontSize: 12, marginTop: 2 }}>
                المقالات · الأحاديث · القبلة · التسبيح · المزيد
              </Text>
            </View>
...
const styles = StyleSheet.create({
  ...
  // (Library cards moved to /tools — Mushaf tab is now Quran-only)
  // ════ Tools banner ════
  toolsBanner: {
    flexDirection: 'row',
    alignItems: 'center',
